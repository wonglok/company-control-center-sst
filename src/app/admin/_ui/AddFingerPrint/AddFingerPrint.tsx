    ...
    return (
        <>
            <Card className='size-full'>
                ...
                <CardContent>
                    <div
                        className='rounded-2xl border border-gray-200 pt-3 w-full h-full flex flex-col justify-center items-center cursor-pointer hover:bg-gray-100'
                        onClick={() => {
                            makePasskey().catch((r) => {
                                console.log(r)
                            })
          ...
          c-3.849-1.533-8.21,0.345-9.743,4.192C315.998,25.488,317.876,29.851,321.724,31.383z'
                        ...
                        <div className='my-3 text-center'>Add Passkey</div>
                    </div>
                </CardContent>
            </Card>
