                        ...
                        {images.map((r: any) => {
                            return (
                                <div key={r.fileKey}>
                                    <img
                                        alt={'img'}
                                        className='w-[200px] h-[200px] shrink-0 object-contain'
                                        src={r.contentURL}
                                    ></img>
                                </div>
                            )
...
function BlueBlock({ value = '', color = 'blue', text = 'Loading...' }) {
    ...
    return (
        <div onClick={() => {}} className={`rounded-lg py-2 px-3 bg-blue-200 text-blue-800 cursor-pointer  flex`}>
            <span ref={refStatus} className={`bg-blue-100 px-3 text-sm py-1 mx-2 select-none`}>
                {text}
            </span>
...
function GreenBlock({ value = '', color = 'blue', text = 'Loading...' }) {
    ...
    return (
        <div onClick={() => {}} className={`rounded-lg py-2 px-3 bg-green-200 text-green-800 cursor-pointer  flex`}>
            <span ref={refStatus} className={`bg-green-100 px-3 text-sm py-1 mx-2 select-none`}>
                {text}
            </span>
